...
- App: `NODE_ENV`
- Networking: `API_PORT`, `DASHBOARD_PORT`, `API_URL`, `NEXT_PUBLIC_API_URL`, `CORS_ORIGINS`, `WS_PATH`
...
- Maintenance/backup (prod): `RETENTION_DAYS`, `CONTENT_TRASH_RETENTION_DAYS`, `BACKUP_DIR`, `TZ`
