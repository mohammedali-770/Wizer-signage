...
import { AndroidUpdateController } from './android-update.controller';
...
@Module({
  ...
  controllers: [DeviceController, ScreenPairingController, AndroidUpdateController],
  providers: [DeviceService, DeviceContentService, DeviceAuthGuard, AndroidUpdateService],
