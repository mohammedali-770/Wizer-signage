...
async function bootstrap(): Promise<void> {
  ...
  // Nest 11's native JSON logger keeps framework logs and every existing
  // `new Logger(...)` call machine-readable without introducing a second logging
  // dependency. Production defaults to JSON; local development remains human
  // friendly unless LOG_FORMAT=json is explicitly requested.
