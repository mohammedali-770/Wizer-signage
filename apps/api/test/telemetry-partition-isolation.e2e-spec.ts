...
describe('telemetry partition PostgreSQL ownership boundary', () => {
  ...
  it('keeps only the Prisma-owned partition parents in public', async () => {
    const rows = await prisma.$queryRaw<
      Array<Row<'relname' | 'relkind' | 'schema'>>
    >`SELECT c.relname,
